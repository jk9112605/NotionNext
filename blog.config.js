...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi! Welcome to my blog, Hi! This is jk',
  ...
  COMMENT_VALINE_PLACEHOLDER:
    process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '搶個沙發吧~', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'yId0dz_pAxq1Y2aEH3KjtzaJ7m7h5zw1MPVgVdPJRTA', // Remove the value or replace it with your own google site verification code
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-5604761970170883', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE: 
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '8542259792', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW: 
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '1015123568', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE: 
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '7388960226', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO: 
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '7743666529', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
